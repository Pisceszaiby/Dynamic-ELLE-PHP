...
$fashion = mysqli_query($mysqli, "SELECT * FROM post WHERE category='SHOP';");
?>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="padding-bottom: 0%;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                      <b>  <a class="nav-link neue" href="fashion.php">Fashion</a></b>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container-fluid">
            <div style="position: relative;text-align: center;color: white;">
                <img style="margin:0px;padding:0%; width: 100%;"
                    src="https://hips.hearstapps.com/hmg-prod/images/elm080121wladut006f-1645814173.jpg?crop=1.00xw:0.390xh;0,0.0710xh&amp;resize=1024:*"
                    alt="">
                <h1 style="position: absolute;top: 30%;left: 10%;" >
                    FASHION
                </h1>
                <h3 class="sub-heading" style="position: absolute;top: 45%;left: 10%;">What's New ?</h3>
            </div>
            <hr>
            <div class="row main">
                <h1>
