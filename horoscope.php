...
$horoscope = mysqli_query($mysqli, "SELECT * FROM post WHERE category='HOROSCOPE';");
?>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link neue" href="#footer">Fashion</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link neue" href="#pricing">Beauty</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link neue" href="#cta">Culture</a>
                    </li>
                    <li class="nav-item">
                        <B><a class="nav-link neue" href="#cta">Horoscope</a></B>
                    </li>
                </ul>
            </div>
        </nav>
            ...
            <!-- Title -->
                    ...
                    <div class="offcanvas  offcanvas-start " data-bs-backdrop="static" tabindex="-1" id="staticBackdrop"
                        ...
                        <div style="width:100%" class=" neue offcanvas-body">
                            ...
                            <br>
                            <a data-bs-toggle="collapse" href="#culture" aria-expanded="false"
                                aria-controls="collapseExample">
                            ...
                            <br>
                            <a data-bs-toggle="collapse" href="#love" aria-expanded="false"
                                aria-controls="collapseExample">
                            ...
                            <br>
                            <a data-bs-toggle="collapse" href="#follow" aria-expanded="false"
                                aria-controls="collapseExample">
                            ...
                            <a data-bs-toggle="collapse" href="#us" aria-expanded="false"
                                aria-controls="collapseExample">
    ...
    <section>
        <div class="container-fluid">
            <a href="https://www.elle.com/fashion/">
                <h1>
                    HOROSCOPE
                </h1>
            </a>
            ...
            <hr>
            <!-- div to create 4 images in a row -->
                <div class="row">
                    <?php
                    $count = 0;
                    while ($res = mysqli_fetch_array($horoscope)) {
                        $heading = $res['heading'];
                        $picPath = $res['picPath'];
                        $url = $res['url'];
                        if ($count < 12) {
