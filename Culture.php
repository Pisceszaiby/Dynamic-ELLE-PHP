...
$culture = mysqli_query($mysqli, "SELECT * FROM post WHERE category='CULTURE';");
?>
...
<body>
   ...
   <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light" style="padding-bottom: 0%;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                       <b> <a class="nav-link neue" href="Culture.php">Culture</a></b>
                    </li>
                    <li class="nav-item">
    ...
    <section>
        <div class="container-fluid">
            <div style="position: relative;text-align: center;color: rgb(14, 12, 12);">
                <img style="margin:0px;padding:0%; width: 100%; "
                    src="https://hips.hearstapps.com/hmg-prod/images/alex-cooper-cazzie-david-emilio-madrid-l1000280-1670015930.jpg?crop=1.00xw:0.673xh;0,0.0903xh&amp;resize=1024:*"
                    alt="">
                <h1 style="position: absolute;top: 20%;left: 20%;">
                    CULTURE
                </h1>
                <h3 class="sub-heading" style="position: absolute;top: 35%;left: 20%;">Identify your Identity</h3>
            </div>
            <hr>
            <div class="row main">
                <h1>
